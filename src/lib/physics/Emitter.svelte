<script lang="ts">
	...
	import Particle from '$lib/physics/Particle.svelte';
	...
	const getRandomPosition = () => {
		return new Vector3(0.5 - Math.random() * 1, 5 - Math.random() * 1 + 3, 0.5 - Math.random() * 1);
	};
	...
	let longevityMilliseconds = 8_000;
